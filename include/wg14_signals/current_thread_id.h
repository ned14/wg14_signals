...
extern "C"
{
  ...
  WG14_SIGNALS_EXTERN WG14_SIGNALS_THREAD_LOCAL WG14_SIGNALS_PREFIX(thread_id_t)
  WG14_SIGNALS_PREFIX(current_thread_id_cached);

  WG14_SIGNALS_EXTERN void WG14_SIGNALS_PREFIX(current_thread_id_cached_set)();

  //! \brief THREADSAFE; ASYNC SIGNAL SAFE; Retrieve the current thread id
  static WG14_SIGNALS_INLINE WG14_SIGNALS_PREFIX(thread_id_t) WG14_SIGNALS_PREFIX(current_thread_id)()
  {
